class MTTLW01Card extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      .summary-item{box-sizing:border-box;min-width:0;height:42px;padding:1px 9px;border:1px solid color-mix(in srgb,var(--success-color,#22c55e) 30%,var(--divider-color));border-radius:9px;background:color-mix(in srgb,var(--success-color,#22c55e) 10%,var(--card-background-color));display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0;color:var(--primary-text-color)}
      .summary-item span{color:var(--secondary-text-color);font-size:12px;line-height:1.05}.summary-item strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:1.1}
